...
home_dir="/mnt/c/Users/User/Desktop/HCP_WM_Datasets_2C"
cd $home_dir
...
design_fn=${design_fn#./}
des_temp=$(echo $design_fn | tr -d './')
str_temp=$(grep -i "/mnt/c/Users/User/Desktop/HCP_WM_Datasets_2C/fmri/*" $design_fn)
