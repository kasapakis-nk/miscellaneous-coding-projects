...
column_labels = {'acc_per_fold_69'};
writematrix(box_plot_accs_per_fold_count,'classification_results.xlsx','Sheet','2C_fold','Range','G8')
writecell(column_labels,'classification_results.xlsx','Sheet','2C_fold','Range','G7')