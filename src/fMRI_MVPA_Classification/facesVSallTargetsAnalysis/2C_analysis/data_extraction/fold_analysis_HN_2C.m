...
writecell(box_col_labels,'classification_results.xlsx','Sheet','2C_fold_HN','Range','A16')
writematrix(box_plot_accs_per_fold_count,'classification_results.xlsx','Sheet','2C_fold_HN','Range','A17')

writecell(column_labels,'classification_results.xlsx','Sheet','2C_fold_HN','Range','A1:E1')
writematrix(final_mat,'classification_results.xlsx','Sheet','2C_fold_HN','Range','A2')
writematrix(acc_avg_over_analyses,'classification_results.xlsx','Sheet','2C_fold_HN','Range','G2')
writematrix('overall_acc_mean','classification_results.xlsx','Sheet','2C_fold_HN','Range','G1')