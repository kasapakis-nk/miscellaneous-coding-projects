...
writecell(column_labels,'classification_results.xlsx','Sheet','4C_fold','Range','A1:E1')
writematrix(final_mat,'classification_results.xlsx','Sheet','4C_fold','Range','A2')
writematrix(acc_avg_over_analyses,'classification_results.xlsx','Sheet','4C_fold','Range','G2')
writematrix('overall_acc_mean','classification_results.xlsx','Sheet','4C_fold','Range','G1')