...
writecell(box_col_labels,'classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','A16')
writematrix(box_plot_accs_per_fold_count,'classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','A17')

writecell(column_labels,'classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','A1:E1')
writematrix(final_mat,'classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','A2')
writematrix(acc_avg_over_analyses,'classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','G2')
writematrix('overall_acc_mean','classif_res_ffa.xlsx','Sheet','4C_fold_HN','Range','G1')