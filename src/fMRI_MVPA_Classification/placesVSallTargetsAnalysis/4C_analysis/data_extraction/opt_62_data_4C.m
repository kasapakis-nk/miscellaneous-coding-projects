...
column_labels = {'acc_per_fold_62'};
writematrix(box_plot_accs_per_fold_count,'classif_res_ppa.xlsx','Sheet','4C_fold','Range','G8')
writecell(column_labels,'classif_res_ppa.xlsx','Sheet','4C_fold','Range','G7')