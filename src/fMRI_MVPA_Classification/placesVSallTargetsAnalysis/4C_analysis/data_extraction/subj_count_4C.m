...
for i = 1:numel(chosen_subj_count)
    ...
    elseif subj_count == 2
        ...
        fold_count = 62; %optimal fold_count 62
    end
    max_fold_count = 200;
...
writecell(subj_count_col_labels,'classif_res_ppa.xlsx','Sheet','4C_box_subj_count','Range','A1')
writematrix(box_plot_accs_per_subj_count,'classif_res_ppa.xlsx','Sheet','4C_box_subj_count','Range','A2')

writecell(column_labels,'classif_res_ppa.xlsx','Sheet','4C_subj_count','Range','A1:E1')
writematrix(final_mat,'classif_res_ppa.xlsx','Sheet','4C_subj_count','Range','A2')
writematrix(acc_avg_over_analyses,'classif_res_ppa.xlsx','Sheet','4C_subj_count','Range','G2')
writematrix('overall_acc_mean_1_to_19','classif_res_ppa.xlsx','Sheet','4C_subj_count','Range','G1')