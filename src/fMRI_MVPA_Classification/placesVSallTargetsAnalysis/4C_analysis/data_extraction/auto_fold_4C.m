...
writecell(column_labels,'classif_res_ppa.xlsx','Sheet','4C_fold','Range','A1:E1')
writematrix(final_mat,'classif_res_ppa.xlsx','Sheet','4C_fold','Range','A2')
writematrix(acc_avg_over_analyses,'classif_res_ppa.xlsx','Sheet','4C_fold','Range','G2')
writematrix('overall_acc_mean','classif_res_ppa.xlsx','Sheet','4C_fold','Range','G1')